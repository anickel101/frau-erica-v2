...
function formatBirthDate(iso?: string): string {
  ...
  return `Born ${date.toLocaleDateString('en-US', { day: 'numeric', month: 'long', year: 'numeric' })}`
}
...
export const sampleFamily: FamilyPageData = {
  family_id: 19,
  person_1: { person_id: 23, first_name: 'Anson', last_name: 'Nickel', date_of_birth: '1987-10-24' },
  person_2: { person_id: 1189, first_name: 'Reva', last_name: 'Gaur', date_of_birth: '1985-01-05' },
  description:
  ...
  grandparents_1: [
    { person_id: 18, first_name: 'Mark', last_name: 'Nickel', date_of_birth: '1948-11-02' },
    { person_id: 19, first_name: 'Mary Allison', last_name: 'McMillan', date_of_birth: '1952-04-21' },
  ],
  grandparents_2: [
    { person_id: 2001, first_name: 'Umesh', last_name: 'Gaur', date_of_birth: '1952-08-13' },
    { person_id: 2002, first_name: 'Sunanda', last_name: 'Mani', date_of_birth: '1956-04-11' },
  ],
  children: [
    { person_id: 1062, first_name: 'Archer', last_name: 'Nickel', date_of_birth: '2018-05-02' },
    { person_id: 1159, first_name: 'Leia', last_name: 'Nickel', date_of_birth: '2020-12-10' },
  ],
}
